...
const LANDING_PAGES: Record<LandingPageSlug, { en: LandingPageContent; zh: LandingPageContent }> = {
  'will-he-contact-me-tarot': {
    en: {
      ...
      seo: {
        title: 'Will He Contact Me? AI Tarot Reading | Free Online Tool',
        description: 'Free AI tarot reading to answer "Will he contact me?" Get instant insights about communication and connection with our three-card spread.',
    ...
    zh: {
      slug: 'will-he-contact-me-tarot',
      seo: {
        title: '他会联系我吗？AI塔罗占卜 | 免费在线工具',
        description: '免费AI塔罗占卜解答"他会联系我吗？"通过三牌阵获得关于沟通和感情的即时洞察。',
  ...
  'love-tarot-reading': {
    en: {
      ...
      seo: {
        title: 'Free Love Tarot Reading | AI-Powered Relationship Insights',
        description: 'Get a free AI love tarot reading. Gain clarity on your romantic life, relationships, and emotional connections with our intelligent three-card spread.',
    ...
    zh: {
      slug: 'love-tarot-reading',
      seo: {
        title: '免费爱情塔罗占卜 | AI智能感情解读',
        description: '获取免费AI爱情塔罗解读。通过智能三牌阵，深入了解你的浪漫生活、感情关系和情感连接。',
  ...
  'should-i-leave-my-job-tarot': {
    en: {
      ...
      seo: {
        title: 'Should I Leave My Job? Tarot Reading | AI Career Guidance',
        description: 'Free AI tarot reading for career decisions. Gain clarity on whether to stay or leave your job with insightful three-card spread analysis.',
    ...
    zh: {
      slug: 'should-i-leave-my-job-tarot',
      seo: {
        title: '我该辞职吗？塔罗占卜 | AI职业指导',
        description: '免费AI塔罗职业占卜。通过深度三牌阵分析，帮助你在去留之间获得清晰的洞察。',
  ...
  'career-tarot-reading': {
    en: {
      ...
      seo: {
        title: 'Free Career Tarot Reading | AI Professional Path Guidance',
        description: 'Get a free AI career tarot reading. Explore your professional path, work challenges, and career opportunities with our insightful three-card spread.',
    ...
    zh: {
      slug: 'career-tarot-reading',
      seo: {
        title: '免费事业塔罗占卜 | AI职业道路指导',
        description: '获取免费AI事业塔罗解读。通过深度三牌阵，探索你的职业道路、工作挑战和事业机遇。',
  ...
  'daily-tarot-guidance': {
    en: {
      ...
      seo: {
        title: 'Daily Tarot Guidance | Free AI Daily Card Reading',
        description: 'Get your free daily tarot card reading. Start each day with AI-powered guidance and intention-setting to navigate life with clarity.',
    ...
    zh: {
      slug: 'daily-tarot-guidance',
      seo: {
        title: '每日塔罗指引 | 免费AI每日塔罗牌',
        description: '获取免费每日塔罗牌解读。用AI指引开启每一天，为生活设定方向，获得清晰的洞察。',
